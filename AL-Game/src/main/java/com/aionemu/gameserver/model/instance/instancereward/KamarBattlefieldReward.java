...
public class KamarBattlefieldReward extends InstanceReward<KamarBattlefieldPlayerReward> {
	...
	public List<KamarBattlefieldPlayerReward> sortPoints() {
		List<KamarBattlefieldPlayerReward> rewards = getInstanceRewards();
		Collections.sort(rewards, new Comparator<KamarBattlefieldPlayerReward>() {
			@Override
			public int compare(KamarBattlefieldPlayerReward o1, KamarBattlefieldPlayerReward o2) {
	...
	public boolean hasCapPoints() {
		return Collections.max(getInstanceRewards(), Comparator.comparingInt(KamarBattlefieldPlayerReward::getPoints)).getPoints() >= capPoints;
	}
}