...
public class NeviwindCanyonReward extends InstanceReward<NeviwindCanyonPlayerReward> {
    ...
    public List<NeviwindCanyonPlayerReward> sortPoints() {
        List<NeviwindCanyonPlayerReward> rewards = getInstanceRewards();
        Collections.sort(rewards, new Comparator<NeviwindCanyonPlayerReward>() {
            @Override
            public int compare(NeviwindCanyonPlayerReward o1, NeviwindCanyonPlayerReward o2) {
    ...
    public boolean hasCapPoints() {
        return Collections.max(getInstanceRewards(), Comparator.comparingInt(NeviwindCanyonPlayerReward::getPoints)).getPoints() >= capPoints;
    }
}