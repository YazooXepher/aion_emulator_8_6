...
public class RunatoriumReward extends InstanceReward<RunatoriumPlayerReward> {
	...
	public List<RunatoriumPlayerReward> sortPoints() {
		List<RunatoriumPlayerReward> rewards = getInstanceRewards();
		Collections.sort(rewards, new Comparator<RunatoriumPlayerReward>() {
			@Override
			public int compare(RunatoriumPlayerReward o1, RunatoriumPlayerReward o2) {
