...
public abstract class CraftGroup extends BonusItemGroup {
	...
	private ConcurrentHashMap<Integer, ConcurrentHashMap<Range<Integer>, List<CraftReward>>> dataHolder;
	 ...
	 */
	public ConcurrentHashMap<Integer, ConcurrentHashMap<Range<Integer>, List<CraftReward>>> getDataHolder() {
		return dataHolder;
	}
	 ...
	 */
	public void setDataHolder(ConcurrentHashMap<Integer, ConcurrentHashMap<Range<Integer>, List<CraftReward>>> dataHolder) {
