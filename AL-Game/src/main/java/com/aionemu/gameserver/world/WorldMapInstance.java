...
public abstract class WorldMapInstance {
	 ...
	 */
	private final ConcurrentHashMap<Integer, VisibleObject> worldMapObjects = new ConcurrentHashMap<>();
	/**
	...
	private final Set<Integer> registeredObjects = Collections.newSetFromMap(new ConcurrentHashMap<>());
