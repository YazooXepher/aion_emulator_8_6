...
public class SiegeRaceCounter implements Comparable<SiegeRaceCounter> {
	...
	private final Map<Integer, AtomicLong> playerGPCounter = new ConcurrentHashMap<Integer, AtomicLong>();
	private final Map<Integer, AtomicLong> legionDamageCounter = new ConcurrentHashMap<Integer, AtomicLong>();
