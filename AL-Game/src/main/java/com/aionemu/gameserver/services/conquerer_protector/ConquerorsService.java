...
public class ConquerorsService {
	...
	private ConcurrentHashMap<Integer, MapTypes> usedWorldMaps = new ConcurrentHashMap<Integer, MapTypes>();
	private ConcurrentHashMap<Integer, PlayerConquererProtectorData> players = new ConcurrentHashMap<Integer, PlayerConquererProtectorData>();
	private ConcurrentHashMap<Integer, Future<?>> pduration = new ConcurrentHashMap<Integer, Future<?>>();
	private ConcurrentHashMap<Integer, Future<?>> cduration = new ConcurrentHashMap<Integer, Future<?>>();
