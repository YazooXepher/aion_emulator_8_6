...
public class LumielTransformService {
	...
	private List<LumielTransformTemplate> activeLumiel = new ArrayList<LumielTransformTemplate>();
	private static Map<Integer, List<LumielRewardItem>> playerRewards = new ConcurrentHashMap<Integer, List<LumielRewardItem>>();
	...
	public void onGenerateReward(Player player, int lumielId) {
		...
		ArrayList<LumielRewardItem> rewardItems = new ArrayList<LumielRewardItem>();
	...
	public List<LumielRewardItem> getPlayerRewardList(Player player) {
		ArrayList<LumielRewardItem> rewards = new ArrayList<LumielRewardItem>();
