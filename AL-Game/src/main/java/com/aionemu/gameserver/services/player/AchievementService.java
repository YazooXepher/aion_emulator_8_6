...
public class AchievementService {
	...
	private List<AchievementTemplate> daily = new ArrayList<AchievementTemplate>();
	private List<AchievementTemplate> weekly = new ArrayList<AchievementTemplate>();
	...
	private List<AchievementEventTemplate> activeEventEly = new ArrayList<AchievementEventTemplate>();
	private List<AchievementEventTemplate> activeEventAsmo = new ArrayList<AchievementEventTemplate>();
