...
public class VortexData {
	...
	@XmlTransient
	private ConcurrentHashMap<Integer, VortexLocation> vortex = new ConcurrentHashMap<Integer, VortexLocation>();
	...
	public ConcurrentHashMap<Integer, VortexLocation> getVortexLocations() {
		return vortex;
	}
}
