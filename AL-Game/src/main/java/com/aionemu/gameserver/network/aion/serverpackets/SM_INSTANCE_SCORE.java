	...
	protected void writeImpl(AionConnection con) {
		...
		switch (mapId) {
			...
			case 301100000: // Training Arena of Unity
				...
				switch (type) {
					...
					case 6:
						...
						writeD(0);
						writeD(harmonyArena.getRound());
						ArrayList<HarmonyGroupReward> groups = harmonyArena.getHarmonyGroupInside();
						writeC(groups.size());
						for (HarmonyGroupReward group : groups) {
							...
							ArrayList<Player> members = harmonyArena.getPlayersInside(group);
							writeC(members.size());
							int i = 0;
			...
			case 300320000: // Empyrean Crucible Challenge
				for (CruciblePlayerReward playerReward : (ArrayList<CruciblePlayerReward>) instanceReward.getInstanceRewards()) {
