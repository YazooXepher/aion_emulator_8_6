...
public class GeoWorldLoader {
	...
	private static void destroyDirectByteBuffer(Buffer toBeDestroyed) {
		// La méthode DirectBuffer.cleaner() n'est plus accessible en Java 9+.
		// La libération de la mémoire directe est désormais gérée par le GC.
		// On conserve la méthode vide pour compatibilité.
	}
}