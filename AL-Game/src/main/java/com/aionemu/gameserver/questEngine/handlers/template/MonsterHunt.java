...
public class MonsterHunt extends QuestHandler {
	...
	public MonsterHunt(int questId, List<Integer> startNpcIds, List<Integer> endNpcIds, ConcurrentHashMap<Monster, Set<Integer>> monsters, int startDialog, int endDialog, List<Integer> aggroNpcs, int invasionWorld) {
		super(questId);
