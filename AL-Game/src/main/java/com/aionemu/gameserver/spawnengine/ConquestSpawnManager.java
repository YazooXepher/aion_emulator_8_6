...
public class ConquestSpawnManager {
	...
	private static Map<WorldPosition, ArrayList<SpawnTemplate>> spawnsByPosition = new HashMap<WorldPosition, ArrayList<SpawnTemplate>>();
	private static Map<Integer, ArrayList<WorldPosition>> portals = new HashMap<Integer, ArrayList<WorldPosition>>();

	private static ArrayList<VisibleObject> spawned = new ArrayList<VisibleObject>();

	public static void spawnAll() {
		int spawns = 0;
		for (Entry<WorldPosition, ArrayList<SpawnTemplate>> spawnpos : spawnsByPosition.entrySet()) {
	...
	public static void addConquestSpawnTemplate(SpawnGroup2 sg) {
		for (SpawnTemplate spawn : sg.getSpawnTemplates()) {
			...
			for (Entry<WorldPosition, ArrayList<SpawnTemplate>> set : spawnsByPosition.entrySet()) {
			...
			if (spawnsByPosition.containsKey(pos))
				...
				ArrayList<SpawnTemplate> stList = new ArrayList<SpawnTemplate>();
	...
	public static void writeTemplate() {
		...
		ArrayList<Integer> npc_gelk = new ArrayList<Integer>();
		ArrayList<Integer> npc_ingg = new ArrayList<Integer>();
	...
	public static ArrayList<WorldPosition> getLocationsByNpcId(int npcId) {
