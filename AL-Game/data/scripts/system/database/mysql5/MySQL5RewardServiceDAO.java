...
public class MySQL5RewardServiceDAO extends RewardServiceDAO {
	...
	@Override
	public ArrayList<RewardEntryItem> getAvailable(int playerId) {
		ArrayList<RewardEntryItem> list = new ArrayList<>();
		Connection con = null;
		try {
	...
	@Override
	public void uncheckAvailable(ArrayList<Integer> ids) {
		Connection con = null;
		try {
			con = DatabaseFactory.getConnection();
